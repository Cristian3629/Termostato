...
float temperature_calculate_speed(int frecuencia){
...
float temperature_tranformar(int temp){
...
int temperature_convertion_hex_to_Dec(char* hexadecimal) {
    int numDecimal = 0;
...
int temperature_calculate(char hexa[5],char temp[5],int largo){
  int num = temperature_convertion_hex_to_Dec(hexa);
  float numTrans = temperature_tranformar(num);
